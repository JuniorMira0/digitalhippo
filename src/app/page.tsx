...
export default function Home() {
  ...
  <MaxWidthWrapper>
    <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
      ...
      <p className='mt-6 text-lg max-w-prose text-muted-foreground'>Welcome to DigitalHippo. Every asset on our plataform is verifid by our team to ensure our higest quality standarts.</p>
